...
public class AdditionExpressionParserTest
{
    ...
    public void Parse5Plus2()
    {
        ...
        // "5 + 2"
        IResult<Expression> result = Parsers.AdditionExpression.TryParse("5 + 2");
        Assert.True(result.WasSuccessful);
        Value evalResult = result.Value.Evaluate();
    ...
    public void Parse5Plus2Plus9()
    {
        ...
        // "5 + 2"
        IResult<Expression> result = Parsers.AdditionExpression.TryParse("5    +  2  +    9");
        Assert.True(result.WasSuccessful);
        Value evalResult = result.Value.Evaluate();
    ...
    public void Parse5Plus2d6()
    {
        ...
        IResult<Expression> result = Parsers.AdditionExpression.TryParse("5    +  2d6");
        Assert.True(result.WasSuccessful);
    ...
    public void Parse2d4Plus3d3()
    {
        ...
        Mock<IRandom> moqRandom = new ();
        DiceGroupExpression.DefaultRandomSource = moqRandom.Object;
        IResult<Expression> result = Parsers.AdditionExpression.TryParse("2d4    +  3d3");
        Assert.True(result.WasSuccessful);
